...
public:
  ...
  bool openFrame(STOFFPosition const &pos);
  ...
  void insertChart(STOFFPosition const &pos, STOFFChart &chart/*, STOFFGraphicStyle const &style=STOFFGraphicStyle::emptyStyle()*/);
  ...
  void insertShape(STOFFPosition const &pos, STOFFGraphicShape const &shape,
  ...
  void insertTable(STOFFPosition const &pos, STOFFTable &table/*, STOFFGraphicStyle const &style=STOFFGraphicStyle::emptyStyle()*/);
  /** open a table */
