...
/*
 * StarEncoding to read/parse some Japanese encoding in StarOffice documents
 *
 */
#ifndef STAR_ENCODING_JAPANESE
#  define STAR_ENCODING_JAPANESE
